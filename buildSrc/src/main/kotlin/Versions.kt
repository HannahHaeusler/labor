...
object Versions {
    ...
    object Plugins {
        ...
        const val jig = "2021.1.2"
        const val jk1DependencyLicenseReport = "1.16"
    }

    const val javaMin = "15.0.1"
    ...
    const val hibernateValidator = "6.2.0.Final"
    ...
    //const val nettyCodecHttp = "4.1.54.Final"
    const val nettyCodecHttp = "4.1.54.Final"
    //const val reactiveStreams = "1.0.3"
    //const val reactorBom = "2020.0.2"
    // fuer kapt mit spring-context-indexer
    const val springBom = "5.3.2"
    const val springDataBom = "2021.0.0-M1"
    //const val springDataMongoDB = "3.2.0-M1"
    //const val springGraalvmNative = "0.8.2"
    //const val springHateoas = "1.2.2"
