...
/**
 * Mit der Klasse [LaborModelAssembler] können Entity-Objekte der Klasse [com.acme.labor.entity.Labor].
...
class LaborModelAssembler : SimpleReactiveRepresentationModelAssembler<Labor> {
     ...
     * @return Model für die Labore mit Atom-Links für HATEOAS
     */
    override fun addLinks(laborModel: EntityModel<Labor>, exchange: ServerWebExchange):
        EntityModel<Labor> {
    ...
    /**
     * Collection mit mehreren EntityModel-Instanzen eines Labor-Objektes (gemäß Spring HATEOAS)
     * um Atom-Links ergänzen.
     * @param resources Liste oder Menge von Labore mit _allen_ Atom-Links für HATEOAS
     * @param exchange Objekt für eine Request-Response-Interaktion aus dem Spring Framework
     * @return Model für die Liste oder Menge von Labore mit jeweils einem self-Links für HATEOAS
     */
