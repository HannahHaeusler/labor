 ...
 * @param id Eine Labor-ID oder null als Defaultwert
 * @return Die Basis-URI als String
 */
fun getBaseUri(headers: HttpHeaders, uri: URI, id: LaborId? = null): String {
    val envoyOriginalPath = headers.getFirst("x-envoy-original-path")
    if (envoyOriginalPath != null) {
        // Forwarding durch Envoy von K8s
        // host: "localhost"
        // x-forwarded-proto: "http"
        // x-envoy-decorator-operation: "labor.acme.svc.cluster.local:8080/labore/*",
        // x-envoy-original-path: "/labore/api/00000000-0000-0000-0000-000000000001"
