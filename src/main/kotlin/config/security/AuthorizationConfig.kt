...
import com.acme.labor.config.security.Rolle.dok
...
interface AuthorizationConfig {
    ...
    fun securityWebFilterChain(http: ServerHttpSecurity): SecurityWebFilterChain = http {
        authorizeExchange {
            ...
            authorize(pathMatchers(POST, apiPath), hasRole(dok))
            authorize(pathMatchers(GET, apiPath, laborIdPath), hasRole(admin))
